...
# Assert
TARGET_OTA_ASSERT_DEVICE := m20lte

# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := SRPRK13A006RU

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 32623136 # This is the maximum known partition size, but it can be higher, so we just omit it
